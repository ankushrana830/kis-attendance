...
router
  ...
  .get(auth("getAttendenceOfDay"), attendenceController.getAttendenceOfDay);
router
...
router
  ...
  .post(
    auth("getCurrentMonthAttendence"),
    attendenceController.getSelectedRangeAttendence
  );
router
  .route("/remove-timeout/:attandenceId")
  .post(auth("removeTimeout"), attendenceController.removeTimeout);
router
  .route("/update-attednence/:userId")
  .put(auth("updateAttendence"), attendenceController.updateAttendence);
router
  .route("/get-specific-date-attendence")
  .get(
    auth("getAttendenceOfDay"),
    attendenceController.getAttendenceOfSpecificDate
  );
router
  .route("/check-in")
  .post(
    auth("checkIn"),
    validate(attendenceValidation.checkIn),
    attendenceController.checkIn
  );
router.route("/check-out").put(auth("checkOut"), attendenceController.checkOut);
router
  .route("/break-start")
  .put(
    auth("breakStart"),
    validate(attendenceValidation.breakStart),
    attendenceController.breakStart
  );
router.route("/break-end").put(auth("breakEnd"), attendenceController.breakEnd);
router
  .route("/today-present-count")
  .get(auth("getTodayPresentCount"), attendenceController.presentUserCount);
router
  .route("/today-report")
  .get(auth("getTodayReport"), attendenceController.todayReport);
